 ...
 */
package com.hybris.newtraining.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, NewtrainingFulfilmentProcessConstants.PARENT_PROCESS);
