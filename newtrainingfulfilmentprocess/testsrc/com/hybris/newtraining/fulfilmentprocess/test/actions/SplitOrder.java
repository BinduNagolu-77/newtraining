 ...
 */
package com.hybris.newtraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NewtrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NewtrainingFulfilmentProcessConstants.PARENT_PROCESS);
