 ...
 */
package com.hybris.newtraining.core.constants;

/**
 * Global class for all NewtrainingCore constants. You can add global constants for your extension into this class.
 */
public final class NewtrainingCoreConstants extends GeneratedNewtrainingCoreConstants
{
	public static final String EXTENSIONNAME = "newtrainingcore";


	private NewtrainingCoreConstants()
	{
		//empty
	}
