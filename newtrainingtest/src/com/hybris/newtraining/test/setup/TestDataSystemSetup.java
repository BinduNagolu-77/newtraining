 ...
 */
package com.hybris.newtraining.test.setup;
...
import com.hybris.newtraining.test.constants.NewtrainingTestConstants;
import com.hybris.newtraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NewtrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/newtrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/newtrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/newtrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/newtrainingtest/import/csquotes.impex");
		}
	}
}
